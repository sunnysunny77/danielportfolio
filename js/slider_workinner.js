...
export const slider_workinner = () => {
  ...
  for (const item of workinner_outer) {

    const inner = item.querySelector(".inner");
    const image1 = item.querySelector(".image-1");
    const image2 = item.querySelector(".image-2");
    const image_fill_left = item.querySelector(".image-fill-left");
    const image_fill_right = item.querySelector(".image-fill-right");
    const open_right = item.querySelector(".open-right");
