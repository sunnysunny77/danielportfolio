                    ...
                    foreach ($work as $index=>$row) {
                        ...
                        ?>
                            ...
                            <div class="has-test row justify-content-md-between">
                                ...
                                <div data-aos="fade-right" class="work-details col-48 col-md-16 col-lg-11 d-flex flex-column">
                                ...
                                <div data-aos="fade-left" class="col-48 col-md-26 col-lg-32 <?php echo $margin_bottom; ?>">
